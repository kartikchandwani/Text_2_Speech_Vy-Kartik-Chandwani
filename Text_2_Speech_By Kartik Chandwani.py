#Text_2_Speech_By Kartik Chandwani
#Text_2_Speech_By Kartik Chandwani Availible Windows me,xp,nt,7 / 8 / 8.1 / 10 
from tkinter import *
...
# window configs
tts = Tk()
tts.wm_title("Text_2_Speech_By Kartik Chandwani")
